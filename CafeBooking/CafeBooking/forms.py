...
class ReservationFilterForm(forms.Form):
    ...
    office = forms.ModelChoiceField(
        queryset=Office.objects.all(), required=True, label="Офис", empty_label=None
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Div(
                Div(
                    Div(
                        Div(Field("date"), css_class="row"),
                        Div(Field("office"), css_class="row"),
                        css_class="box",
                    ),
                ),
                Div(
                    Div(
                        Div(Field("time"), css_class="row"),
                        style="margin-bottom: 10px;",
                        css_class="box",
                    ),
                    Submit(
                        name="check", value="Показать", css_class="button is-primary"
                    ),
                ),
...
class RegForm(forms.Form):
    login = forms.CharField(
        label="Логин", max_length=20, required=True, validators=[login_exists]
    )
    password = forms.CharField(
        label="Пароль", max_length=20, required=True, widget=forms.PasswordInput
    )
    name = forms.CharField(label="Имя", max_length=20, required=True, empty_value=False)
    lastname = forms.CharField(
        label="Фамилия", max_length=20, required=True, empty_value=False
    )
    email = forms.EmailField(
        label="E-mail", required=True, empty_value=False, localize=True
    )
...
class UpdateProfile(forms.ModelForm):
    ...
    password = forms.CharField(
        ...
        min_length=5,
        label="Пароль",
        help_text="Пароль должен содержать минимум 5 символов!",
    )
    login = forms.CharField(label="Логин", max_length=20, required=True)
...
class UserFormAdd(forms.ModelForm):
    Role = (("rseU", "User"), ("deaH", "Head"), ("ndmiA", "Admin"))
        ...
        self.helper.layout = Layout(
            Div(
                ...
                Div(
                    ...
                    Div(
                        HTML(
                            '<button class="button" type="button" name="generate-login" style="margin-top: 20px;"><span class="icon is-small"><i class="fa-solid fa-rotate-right"></i></span></button>'
                        ),
                    ),
                ...
                Div(
                    ...
                    Div(
                        HTML(
                            '<button class="button" type="button" name="show-password" style="margin-bottom: 2px;"><span class="icon is-small"><i class="fa-solid fa-eye"></i></span></button>'
                        ),
                        HTML(
                            '<button class="button" type="button" name="generate-password" style="margin-bottom: 2px;"><span class="icon is-small"><i class="fa-solid fa-rotate-right"></i></span></button>'
                        ),
                        css_class="buttons",
                    ),
                    css_class="field-and-button",
...
class PlaceForm(forms.ModelForm):
    ...
    type_choice = (("Стол", "Стол"), ("Комната", "Комната"))
